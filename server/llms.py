...
MAX_INPUT_TOKENS = 5000  # Maximum tokens for the model
...
def generate_summary(combined_text: str, page_url: str) -> str:
    ...
    prompt = f"Summarize the following text from the following website {page_url}. This may include both web page content and text extracted from screenshots."
    if "amazon.com" in page_url and "order-history" in page_url:
        prompt += "\n\n This is a order history from amazon.com.  Please only include the list of products."
